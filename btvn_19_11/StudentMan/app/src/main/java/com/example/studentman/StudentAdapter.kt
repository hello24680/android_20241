...
class StudentAdapter(
    ...
    inner class StudentViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(student: StudentModel) {
            itemView.findViewById<TextView>(R.id.text_student_name).text = student.studentName
            itemView.findViewById<TextView>(R.id.text_student_id).text = student.studentId
        }
    }
