...
class MainActivity : AppCompatActivity() {
    ...
    private fun showUndoSnackbar(position: Int) {
        ...
        Snackbar.make(rootView, "Student đã xóa", Snackbar.LENGTH_LONG)
            .setAction("UNDO") {
    ...
    private fun showEditStudentDialog(student: StudentModel, position: Int) {
        ...
        editName.setText(student.studentName ?: "") // Nếu name null, thay bằng chuỗi rỗng
        editId.setText(student.studentId ?: "") // Nếu id null, thay bằng chuỗi rỗng
